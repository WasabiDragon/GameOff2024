...
public class EndOfDayMenu : MonoBehaviour
{
	...
	private string GenerateText(bool newGame = false)
	{
		...
		if(newGame)
		{
			_targetText = "You are now entering a Crown sanctioned work area.\nAll required information to avoid termination at your job is displayed on the papers.\nYour day will now commence.";
			return _targetText;
		}
		...
		{
			_targetText += "\nYour participation in the C.R.U.D.E training course is now concluded.\nYour final score is: "+_score.TotalScore+" out of "+_score.TotalSubmitted+".";
		}
